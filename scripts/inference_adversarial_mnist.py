#!/usr/bin/env python3
"""Inference script for pre-trained MNIST Topological Autoencoder on adversarial MNIST datasets"""
...
class AdversarialMNISTDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, attack_type=None):
        ...
        if attack_type:
            ...
            pt_files = list(self.data_dir.glob(f"*{attack_type}*.pt"))
        else:
            # Load all .pt files
...
def main():
    """Main function to run inference on adversarial MNIST datasets."""
    
    # Configuration - modify these paths
    model_path = "path/to/your/mnist_model.pth"  # Your trained MNIST model
    
    # Base directory containing your adversarial datasets
    base_data_dir = "path/to/your/DATASETS/purification/medmnist/mnist"
